...
def body_content():
    return rx.flex(
        ...
        rx.container(
            rx.image(src="/kwotes.png", width="80px", height="80px"), 
            rx.link(
                rx.flex(
        ...
        rx.container(
            # La Zébrelle
            rx.image(src="/la_zebrelle.png", width="80px", height="80px"), 
            rx.link(
                rx.flex(
        ...
        rx.container(
            # Africa vivre 
            rx.image(src="/africa_vivre.png", width="80px", height="80px"), 
            rx.link(
                rx.flex(
...
def footer():
    return rx.flex(
        rx.image(src="/lucille_logo.png", width="50px", height="50px"),
