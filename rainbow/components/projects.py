...
def project_container(
    ...
    return rx.flex(
        rx.container(
                rx.image(src=logo_src, width="100px", height="100px"),
                rx.link(
                    rx.flex(
                ...
                rx.flex(
                    rx.button(button_texts, radius="full", color="black", background_color="white", border="1px solid #000000", size="1", padding_left="10px", padding_right="10px", margin_top="5px", margin_bottom="5px"),
                    rx.button(button_texts, radius="full", color="black", background_color="white", border="1px solid #000000", size="1", padding_left="10px", padding_right="10px", margin_top="5px", margin_bottom="5px"),
                    spacing="1",
                ),
                rx.text(description),
